// ============================================================
// MAINTENANCE STORE — CONFIGURATION FILE
// Fill in YOUR details below. This is the only file you edit.
// ============================================================

const CONFIG = {
  // Get these from: Supabase → Your Project → Settings → API
  SUPABASE_URL: 'https://cyirflajraknseqommzo.supabase.co',
  ...
  // Storekeeper name (auto-fills in outward register)
